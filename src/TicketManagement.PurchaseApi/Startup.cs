...
using TicketManagement.PurchaseApi.Clients;
using TicketManagement.PurchaseApi.JwtTokenAuth;
...
namespace TicketManagement.PurchaseApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddPurchaseDependencies();
            ...
            services.AddRestEaseClient<ITokenClient>(userApi);
