...
--- Create Event Test Data
    ...
    INSERT [dbo].[Event] ([Id], [Name], [Description], [LayoutId], [DateTimeStart], [DateTimeEnd], [ImageUrl]) 
        VALUES (100, N'SetUp Test Name', N'SetUp Test Description', 1, CAST(N'2021-04-19T20:30:00' AS DateTime2), CAST(N'2021-04-19T22:30:00' AS DateTime2), N'1494294b-2274-44ad-8536-268324b799a2_12 (1).jpg')
    INSERT [dbo].[Event] ([Id], [Name], [Description], [LayoutId], [DateTimeStart], [DateTimeEnd], [ImageUrl]) 
        VALUES (101, N'SetUp Test Name 2', N'SetUp Test Description 2', 1, CAST(N'2021-04-19T10:30:00' AS DateTime2), CAST(N'2021-04-19T12:30:00' AS DateTime2), N'1494294b-2274-44ad-8536-268324b799a2_12 (1).jpg')
 ...
 --- Create Ticket Test Data
    ...
    INSERT [dbo].[Ticket] ([Id], [Name], [Description], [UserId], [StartEventDate], [EndEventDate], [Price]) 
        VALUES (100, N'SetUp Test Name', N'SetUp Test Description', 3, CAST(N'2021-04-19T20:30:00' AS DateTime2), CAST(N'2021-04-19T22:30:00' AS DateTime2), 0)
